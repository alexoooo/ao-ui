 ...
 * Time: 1:20:43 PM
 */
public class InlineDetailToggle implements Serializable
{
	//--------------------------------------------------------------------
...
//    private transient List<Component> details;
    ...
    //--------------------------------------------------------------------
    public InlineDetailToggle()
    {
        this( false );
    }
    public InlineDetailToggle(boolean displayInitially)
    {
        this(new Model<Boolean>(displayInitially));
    }

    public InlineDetailToggle(IModel<Boolean> detailIsOpen)
    {
